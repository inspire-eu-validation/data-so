...
The Data Specification on Soil – Technical Guidelines (version 3.0) and the associated GML application schema specifying requirements for the interoperability of spatial data sets of the data theme Soil.

The specification specifies the following conformance classes:

| Conformance class | Standardization target |
| ----------------- | ---------------------- |
| [GML application schemas, Soil](http://inspire.ec.europa.eu/id/ats/data-so/3.0/so-gml) | INSPIRE spatial data set encoded in GML, Soil features |
| [Application Schema, Soil](http://inspire.ec.europa.eu/id/ats/data-so/3.0/so-as) | INSPIRE spatial data set |
| [Reference Systems, Soil](http://inspire.ec.europa.eu/id/ats/data-so/3.0/so-rs) | INSPIRE spatial data set |
| [Data Consistency, Soil](http://inspire.ec.europa.eu/id/ats/data-so/3.0/so-dc) | INSPIRE spatial data set |
| [Information Accessibility, Soil](http://inspire.ec.europa.eu/id/ats/data-so/3.0/so-ia) | INSPIRE spatial data set |
| [Portrayal, Soil](http://inspire.ec.europa.eu/id/ats/data-so/3.0/so-portrayal) | INSPIRE view service |
...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Soil - Core", are not needed as no feature instance can be of a type from that application schema.
